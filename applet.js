...
MyApplet.prototype = {
  ...
  _init: function(metadata, orientation, panel_height, instance_id) {
    ...
    try {
	  ...
	  this.sshConfig = this.homeDir + "/.local/share/cinnamon/applets/mymenu@podimov/config";
  ...
  updateMenu: function() {
    ...
    try {
      let [res, out, err, status] = GLib.spawn_command_line_sync('grep "^Action " .local/share/cinnamon/applets/mymenu@podimov/config');
      if(out.length!=0) {
